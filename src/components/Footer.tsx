        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-lg">
              15년의 경험과 전문성을 바탕으로 최고 수준의 법률 서비스를 제공하는 
            ...
            <div className="grid grid-cols-3 gap-6 mb-6">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-orange-400 mb-1">900+</div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">info@kimjungsuklaw.co.kr</span>
              </div>
              <div className="flex items-center space-x-3">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-6 text-orange-400">빠른 링크</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-6 text-orange-400">전문 분야</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-start">
            ...
            <div className="flex space-x-8 text-sm">
              <Link href="/faq" className="text-gray-400 hover:text-orange-400 transition-colors text-center min-w-[60px]">
                FAQ
              </Link>
              <Link href="/services" className="text-gray-400 hover:text-orange-400 transition-colors text-center min-w-[60px]">
                사례
              </Link>
              <Link href="/about" className="text-gray-400 hover:text-orange-400 transition-colors text-center min-w-[60px]">
                회사소개
              </Link>
            </div>
          </div>
