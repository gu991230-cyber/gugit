...
export default function Services() {
  // 사례 데이터 - 나중에 실제 이미지와 내용으로 교체 가능
  const cases = [
    {
      id: 1,
      title: "입찰권 사기 피해 회복 사례",
      category: "입찰권",
      description: "공공기관 입찰 관련 사기 피해금 전액 회수 성공",
    ...
    {
      id: 8,
      title: "입찰 자격 배제 구제 사례",
      category: "입찰권",
      description: "부당한 입찰 자격 배제 처분 취소",
    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gray-800 text-white py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-6">성공 사례</h1>
          <p className="text-xl text-gray-200">15년간 축적된 전문성으로 이루어낸 실제 성과들</p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-2xl font-bold text-center text-gray-800 mb-16">고객의 실제 대화내용과 함께 확인하는 성공 스토리</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {cases.map((caseItem) => (
              <div key={caseItem.id} className="bg-white rounded-lg shadow border border-gray-200">
                {/* 이미지 영역 - 카톡 스크린샷이 들어갈 곳 */}
                <div className="aspect-[3/4] bg-gray-200 relative">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.currentTarget.src = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 400"><rect width="300" height="400" fill="%23f3f4f6"/><text x="50%" y="45%" text-anchor="middle" fill="%236b7280" font-size="16">카톡 대화 이미지</text><text x="50%" y="55%" text-anchor="middle" fill="%236b7280" font-size="14">준비 중</text></svg>';
                    }}
                  />
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="bg-white rounded-lg p-6 shadow text-center">
              ...
              <div className="text-lg font-medium text-gray-700">성공 사례</div>
            </div>
            <div className="bg-white rounded-lg p-6 shadow text-center">
      ...
      <section className="py-20 bg-slate-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8">
            위와 같은 성공 사례들처럼, 귀하의 피해도 반드시 회복할 수 있습니다.<br />
