            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 justify-items-center">
              <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-6 w-full max-w-sm">
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-800 mt-1">32년 경력</p>
                </div>
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-6 w-full max-w-sm">
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-800 mt-1">3년 경력</p>
                </div>
                <div className="text-center">
                  <h5 className="text-lg font-bold text-gray-900 mb-2">경력</h5>
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-6 w-full max-w-sm">
                ...
                <div className="text-center">
                  ...
                  <ul className="space-y-1 text-xs md:text-sm leading-relaxed text-gray-800 text-left">
                    ...
                    <li>• 법무법인 소현, 주안 근무</li>
                    <li>• 서울지방변호사회 제9기 증권금융연수원 수료</li>
                    <li>• 미국 워싱턴D.C 국가안보연구소(CIP) 객원 연구원</li>
                    <li>• 언론중재위원회</li>
                    <li>• 한국전기 법률고문</li>
                    <li>• 서울시청 특이민원 대응업무 자문변호인단</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-6 w-full max-w-sm">
                ...
                <div className="text-center">
                  ...
                  <ul className="space-y-1 text-xs md:text-sm leading-relaxed text-gray-800 text-left">
                    ...
                    <li>• 법무법인 명인 변호사</li>
                    <li>• 한국관광공사 법률고문</li>
                    <li>• 여성인권위원회 법률자문위원단</li>
                    <li>• 아동권리보장원 아동학대 자문 전담변호사</li>
